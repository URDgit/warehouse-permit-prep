...
export const FONTANA_ILLUSTRATIVE: OverrideEntry[] = [
  ...
  { path: "fireCode.applicability.storage_height_threshold", value: 12, unit: "ft", status: ILLUS,
    source: "CFC 2022 Ch.32 (high-piled combustible storage > 12 ft; > 6 ft for high-hazard)" },
  { path: "fireCode.aisle_width.minimum", value: 8, unit: "ft", status: ILLUS,
    source: "CFC 2022 §3206.10 (Aisles) / Table 3206.2 (44 in mechanical-stocking min; wider for FD access)" },
  { path: "fireCode.heights.max_pile_height", value: 20, unit: "ft", status: ILLUS,
    source: "CFC 2022 Table 3206.2 (max pile/storage height by commodity & protection)" },
  ...
  { path: "fireCode.sprinkler_design.design_density", value: 0.45, unit: "gpm/sq ft", status: ILLUS,
    source: "NFPA 13 storage design / CFC 2022 Table 3206.2 (design density by commodity & arrangement)" },
  ...
  { path: "fireCode.sprinkler_design.in_rack_sprinklers_required", value: false, status: ILLUS,
    source: "NFPA 13 / CFC 2022 Table 3206.2 (in-rack sprinklers per protection scheme)" },

  // --- Seismic (ASCE 7-16; ANSI/RMI MH16.1) ---
  { path: "seismic.design_basis.rack_design_path", value: "Nonbuilding structure — steel storage rack", status: ILLUS,
    source: "ASCE 7-16 §15.5.3 (steel storage racks)" },
  { path: "seismic.seismic_force.formula_reference", value: "ASCE 7-16 §15.5.3 base shear / ANSI-RMI MH16.1", status: ILLUS,
    source: "ASCE 7-16 §15.5.3; ANSI/RMI MH16.1" },
  { path: "seismic.seismic_force.coefficients.response_modification_R", value: 4, status: ILLUS,
    source: "ASCE 7-16 Table 15.4-1 (R for steel storage racks)" },
  { path: "seismic.seismic_force.coefficients.overstrength_omega0", value: 2, status: ILLUS,
    source: "ASCE 7-16 Table 15.4-1 (Ω₀)" },
  { path: "seismic.seismic_force.coefficients.importance_factor_Ie", value: 1.0, status: ILLUS,
    source: "ASCE 7-16 §1.5 / Table 1.5-2 (Risk Category → Ie)" },
  ...
  { path: "anchorage.anchor_demand.formula_reference", value: "ASCE 7-16 / ANSI-RMI MH16.1 base-plate anchorage demand", status: ILLUS,
    source: "ASCE 7-16; ANSI/RMI MH16.1 (anchorage demand)" },
  ...
  { path: "anchorage.load_combinations.reference", value: "ASCE 7-16 §2.3 / §2.4 load combinations", status: ILLUS,
    source: "ASCE 7-16 §2.3 (LRFD) / §2.4 (ASD)" },
];
